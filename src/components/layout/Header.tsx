...
export function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-[#1A1A1A] border-b border-[#404040] shrink-0 z-10">
      {/* Logo + Breadcrumb */}
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2.5">
          ...
          <div
            ...
            style={{
              background: 'conic-gradient(from 0deg, #005580, #0080B0, #E8E8E6, #F0F0EE, #0080B0, #005580)',
            }}
          >
          ...
          <div>
            ...
            <p className="text-[10px] text-[#E8E8E6] leading-none mt-0.5">Smart Home Simulator</p>
          </div>
        </div>
        ...
        <nav className="flex items-center gap-1 text-xs">
          <button
            ...
            className={`px-2.5 py-1 rounded-lg transition-all ${
              !activeRoomId
                ? 'bg-[#E8E8E6] text-[#111111] font-semibold'
          ...
          {activeRoom && (
            <>
              ...
              <span className="px-2.5 py-1 rounded-lg bg-[#242424] text-[#E8E8E6] font-semibold">
      ...
      <div className="flex items-center gap-3">
        {/* Live energy chip */}
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#242424] border border-[#404040]">
          <span className="text-[10px] text-[#888888]">⚡</span>
          <span className="text-xs font-bold text-white">{totalWatts.toFixed(0)}W</span>
          <span className="text-[10px] text-[#888888]">·</span>
          <span className={`text-xs font-semibold ${onDevices.length > 0 ? 'text-[#5A9A5A]' : 'text-[#888888]'}`}>
            {onDevices.length}<span className="text-[#888888] font-normal">/{totalDevices}</span>
          </span>
        </div>

        {/* Placement mode badge */}
        {isPlacementMode && (
          <span className="text-[10px] bg-[#E8E8E6] text-[#111111] px-2 py-1 rounded-lg font-bold animate-pulse">
            PLACING
          </span>
        )}
        ...
        {layoutLocked ? (
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#242424] border border-[#404040] text-[10px] text-[#888888] hover:text-[#FF8C00] hover:border-[#FF8C0066] transition-colors"
          >
        ...
        <button
          ...
          className={`p-1.5 rounded-lg transition-colors ${
            ui.showMiniMap ? 'text-[#E8E8E6] bg-[#1A3A4A]' : 'text-[#888888] hover:text-white bg-[#242424]'
        ...
        <button
          ...
          title="Import state"
          className="p-1.5 rounded-lg bg-[#242424] border border-[#404040] text-[#888888] hover:text-white transition-colors"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
