...
interface CuteAlexaCanvasProps {
...
export function CuteAlexaCanvas({
  expression,
  bodyColor,
  ledColor,
  ledMode,
  ...
  isSpeaking,
  isSinging,
}: CuteAlexaCanvasProps) {
  // Local interaction states to prevent laggy page-wide React re-renders
...
export default CuteAlexaCanvas;
